...
router.get('/', async function (req, res, next) {
  ...
  let values = ["Newborn", "Boys", "Girls", "Accessories", "Toys", "Strollers & Carrybags", "Feeding props", "Edu-things", "Footwears", "MomToBe-things", "Baby care & Cosmetics","Sports"]
  res.render('./user/index', { admin: false, user, cartCount, pageName: "awaanu", values });
